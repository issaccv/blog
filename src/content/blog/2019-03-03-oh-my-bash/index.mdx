...
早就听过大名鼎鼎的[OhMyZsh](https://github.com/robbyrussell/oh-my-zsh"OhMyZsh")项目，今天就来上手看一看。
...
source ~/.zshrc
```
使得更改立即生效，这个时候你的CLI看起来大概是这个样子的![zsh_agno_def.png](https://www.issacc.top/usr/uploads/2019/03/2553588330.png)看起来我们并不需要主机名称，此时可以更改主题文件
```zsh
vim~/.oh-my-zsh/themes/agnoster.zsh-theme
```
![zsh-2.png](https://www.issacc.top/usr/uploads/2019/03/3351035864.png)注释掉这一行就好，然后重新输入
```zsh
source ~/.zshrc
```
最终的效果就是这样了![zsh-3.png](https://www.issacc.top/usr/uploads/2019/03/4169975935.png)当然，每个主题里还有很多可调参数，自定义程度很高。
...
vim~/.zshrc
```
![zsh-4.png](https://www.issacc.top/usr/uploads/2019/03/3044656122.png)接下来
```zsh
source ~/.zshrc
```

立即生效![zsh-5.png](https://www.issacc.top/usr/uploads/2019/03/2704766646.png)
